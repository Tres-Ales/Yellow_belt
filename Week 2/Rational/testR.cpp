...
void TestPredefined() {
  ...
  AssertEqual(Rational(2147, 2147).Numerator(), 1, "Canonical form of 2147/2147 is 1/1");
  AssertEqual(Rational(2147, 2147).Denominator(), 1, "Canonical form of 2147/2147 is 1/1");
